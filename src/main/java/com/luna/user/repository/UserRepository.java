...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query("""
        ...
        """)
    List<User> findPopularUsersExcluding(@Param("userId") UUID userId, Pageable pageable);
    ...
    @Query(value = """
        ...
        LIMIT :limit
        """, nativeQuery = true)
    List<UserSuggestionProjection> findGraphBasedSuggestions(@Param("userId") UUID userId, @Param("limit") int limit);
